...
Opang sedang terjabak dalam suatu Kotak Ajaib. Kotak ini merupakan kotak berdimensi - $n$, sebut saja Kotak Ajaib ini sebagai $Q_n$. Terdapat juga $2^{n - 1}$ tree yang identik di dekat opang dan masing-masing tree memiliki $n$ edges dan juga $n$ + 1 node yang dinomori 0, 1, ..., $n$. Supaya dapat keluar dari kotak ajaib tersebut, Opang harus meletakkan beberapa tree pada setiap titik sudut dari kotak ajaib tersebut. 
